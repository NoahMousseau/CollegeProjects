...
protected:
    ...
    typename BSTreeNode* copyTree(BSTreeNode* otherNode);
    void clearHelper(BSTreeNode* node);
    typename BSTreeNode* insertOrUpdate(BSTreeNode* node, const DataType& newDataItem);
    bool retrieveHelper(BSTreeNode* node, const KeyType& searchKey, DataType& searchDataItem) const;
    bool removeHelper(BSTreeNode*& node, const KeyType& deleteKey);
    ...
    void writeLessThanHelper(BSTreeNode* node, const KeyType& searchKey) const;
